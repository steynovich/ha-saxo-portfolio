...
class SaxoPortfolioSensor(CoordinatorEntity[SaxoCoordinator], SensorEntity):
    ...
    def native_value(self) -> StateType:
        ...
        try:
            ...
            _LOGGER.error("Error getting native value for %s: %s", self._sensor_type, str(e))
            return None
...
class SaxoAccountSensor(CoordinatorEntity[SaxoCoordinator], SensorEntity):
    ...
    def native_value(self) -> StateType:
        ...
        try:
            ...
            _LOGGER.error("Error getting account balance for %s: %s", self._account_id, str(e))
            return None
...
class SaxoPositionSensor(CoordinatorEntity[SaxoCoordinator], SensorEntity):
    ...
    def native_value(self) -> StateType:
        ...
        try:
            ...
            _LOGGER.error("Error getting position value for %s: %s", self._position_id, str(e))
            return None
